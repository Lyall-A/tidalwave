...
export const config = parseConfig(configPath);

// Read secrets
export const secretsPath = config.secretsPath ? path.resolve(execDir, config.secretsPath) : undefined;
export const secrets = secretsPath && fs.existsSync(secretsPath) ? JSON.parse(fs.readFileSync(secretsPath, 'utf-8')) : { };
...
export const tidalTrackQualities = {
    'LOW': 'HIGH',
    'HIGH': 'LOSSLESS',
    'MAX': 'HI_RES_LOSSLESS'
}
export const tidalVideoQualities = {
    'LOW': '480',
    'MEDIUM': '720',
    'HIGH': '1080',
    'MAX': null
}
export const tidalVideoCoverSizes = {
    '640': '640x640',
    '1280': '1280x1280',
    '1280x720': '1280x720',
    '640x360': '640x360',
...
export const tidalAlbumCoverSizes = {
    '320': '320x320',
    '640': '640x640',
    '1280': '1280x1280',
    'ORIGINAL': 'origin'
}
export const tidalArtistPictureSizes = {
    'ORIGINAL': 'origin'
}
export const tidalPlaylistImageSizes = {
    '320': '320x320',
    '640': '640x640',
    '1280': '1280x1280',
    'ORIGINAL': 'origin'
}
export const tidalMixImageSizes = {
    'SMALL': 'SMALL',
    'MEDIUM': 'MEDIUM',
    'LARGE': 'LARGE'
}
export const tidalCredits = [
...
].map((credit: { type: string; tagName?: string | null }) => {
    // Fill blank tagName
