...
export default function parseAlbum(album: any, additional: any = { }): Album {
    return {
        ...
        credits: additional?.credits?.items ? parseCredits(additional.credits.items) : undefined,
        trackCredits: additional?.trackCredits ? additional.trackCredits.map((i: any) => ({ track: i.item, credits: parseCredits(i.credits) })) : undefined,
